    ...
    <div className="flex flex-col">
      <div className="flex my-10">
        <div className="bg-purple-100 w-1/2 h-full text-xl text-center py-4">
          Доходы
          <Report
            itemCategories={incCategories}
            urlAddress={"https://657636a50febac18d403c5b7.mockapi.io/incItems"}
          />
        </div>
        <div className="bg-green-100 w-1/2 h-full text-xl text-center py-4">
          Расходы
          <Report
            itemCategories={expCategories}
            urlAddress={"https://657636a50febac18d403c5b7.mockapi.io/items"}
          />
        </div>
